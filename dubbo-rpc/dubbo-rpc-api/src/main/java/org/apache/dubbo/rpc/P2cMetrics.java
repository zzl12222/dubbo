...
/**
 * p2c Metrics statistics.
 */
public class P2cMetrics {

    private final ConcurrentMap<String, P2cMetrics> metricsStatistics = new ConcurrentHashMap<>();
    ...
    public double getLoad(String idKey, int weight, int timeout) {
        P2cMetrics metrics = getStatus(idKey);
    ...
    public P2cMetrics getStatus(String idKey) {
        return ConcurrentHashMapUtils.computeIfAbsent(metricsStatistics, idKey, k -> new P2cMetrics());
    }
